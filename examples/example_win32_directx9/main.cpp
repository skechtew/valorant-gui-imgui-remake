...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        static int menu_selection = 0;
        {
            ...
            if (ImGui::ValorantTopButton("Aimbot", menu_selection == 0 ? true : false, ImVec2(130, 40))) menu_selection = 0; ImGui::SameLine(0,0);
            if (ImGui::ValorantTopButton("ESP", menu_selection == 1 ? true : false, ImVec2(130, 40))) menu_selection = 1;
            ...
            if (ImGui::ValorantSubButton("ring-3", asd == 0 ? true : false, ImVec2(130, 45))) asd = 0; ImGui::SameLine(0,0);
            if(ImGui::ValorantSubButton("valorant", asd == 1 ? true : false,ImVec2(130,45))) asd = 1;
