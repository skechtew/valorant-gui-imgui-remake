...
namespace ImGui
{
    ...
    IMGUI_API bool          ValorantSubButton(const char* label, bool isvalid = false,const ImVec2& xsize = ImVec2(0, 0));   // button
    IMGUI_API bool          ValorantTopButton(const char* label, bool isvalid = false,const ImVec2& xsize = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, float col2[4] = {0});
